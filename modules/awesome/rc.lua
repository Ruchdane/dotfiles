...
mylauncher = awful.widget.launcher({ image = beautiful.awesome_icon,
                                     menu = mymainmenu })
powermenu = awful.button( {}, 1 , function () awful.util.spawn("/home/ruchdane/.config/rofi/scripts/launcher_t7") end )
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "d", function () awful.util.spawn("alacritty -e project") end,
          {description = "Launch project chooser", group = "launcher"}),
        awful.key({ modkey }, "x",
              function ()
                  awful.prompt.run {
                    prompt       = "Run Lua code: ",
    ...
    -- Menubar
    awful.key({ modkey }, "p", 
        function() awful.util.spawn("/home/ruchdane/.config/rofi/scripts/launcher_t7") end,
